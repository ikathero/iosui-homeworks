...
struct Post {
  ...
  let author: String // nickname
  var description: String?  // text
  let image: String // pic from assets
  var likes: Int
  var views: Int
    ...
    static func makePost() -> [Post] {
        ...
        model.append(Post(author: "VOGUE", description: "The best photos from British Vogue. By: Steven Meisel", image: "vogue", likes: 27890, views: 135982))
